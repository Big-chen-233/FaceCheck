<template>
  <div class="container">
    ...
    <div class="ranklist" v-for="(item,index) in users" :key="index" :v-if="index < 10">
      <div class="everylist">
        <div class="medal1" v-if="index == 0"><img src="@/assets/fitst4.png" alt=""></div>
        <div class="medal2" v-else-if="index == 1"><img src="@/assets/second2.png" alt=""></div>
        <div class="medal3" v-else-if="index == 2"><img src="@/assets/third3.png" alt=""></div>
